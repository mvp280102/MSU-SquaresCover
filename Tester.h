...
class Tester
{
     ...
     * После выполнения функции в results содержатся результаты тестов трех алгоритмов.
     *
     * ПАРАМЕТРЫ:
     ...
     * В качестве начального количества квадратов используется значение,
     * переданное при инициализации объекта класса. После выполнения функции
     * в results_data содержится набор результатов тестов трех алгоритмов.
     *
     * ПАРАМЕТРЫ:
     * unsigned int high_squares_amount - конечное количество квадратов
     * unsigned int step - шаг изменения
     * bool output - флаг вывод описания процесса выполнения
     */
